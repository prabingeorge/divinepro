        ...
        <motion.div
            ...
            <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
                ...
                <motion.div
                    ...
                    <p className='max-w-md'>From strategy to execution, we craft web applications that move your business forward.</p>
            ...
            <motion.div
                ...
                <p>Copyright 2025 @ divinepro.com - All Right Reserved.</p>
