...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "e58b62fe-1704-4cc2-aa6a-d51485f417ca");
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            id='contact-us' className='flex flex-col items-center gap-10 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
            <Title title='Reach out to us' desc='From strategy to execution, we craft web applications that move your business forward.' />
